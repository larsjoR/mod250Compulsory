...
public class ProductFacade extends AbstractFacade<Product> {
    ...
    public void setPublished(Product product) {
        ...
        prod.setPublishedTime(new Timestamp(Date.from(Instant.now()).getTime()));
    }
}
